package rs.ac.uns.ftn.ues.lucene.indexing.analysers;
...
import rs.ac.uns.ftn.ues.lucene.indexing.filters.CyrilicToLatinFilter;
...
public class SerbianAnalyzer extends Analyzer {
	...
	@Override
	protected TokenStreamComponents createComponents(String arg) {
